...
//        => optionsBuilder.UseSqlServer("Server=(local); DataBase=DBVENTA;Integrated Security=true;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C65945E58");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2190411B");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483E6953148");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107CFDE71F4");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EF0104ECF");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13269E40283");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7689CEA849");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D866D12DDC");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEE4EC4CBF");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A68545FD25");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561403F8D5CE");
