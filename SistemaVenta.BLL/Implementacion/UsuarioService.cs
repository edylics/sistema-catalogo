...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        private readonly IFireBaseService _FireBaeService; 
        ...
        public UsuarioService
            ...
            IFireBaseService FireBaeService,
            IUtilidadesService UtilidadesService,
            ICorreoService CorreoService
            )
        {
            _repositorio = repositorio;
            _FireBaeService = FireBaeService;
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                ...
                if(Foto !=null)
                {
                    ...
                    string urlFoto = await _FireBaeService.SubirStorage(Foto, "carpeta_usuario", NombreFoto);
                ...
                if(UrlPlantillaCorreo != "")
                {
                    ...
                    HttpWebRequest requets = (HttpWebRequest)WebRequest.Create(UrlPlantillaCorreo);
                    HttpWebResponse response = (HttpWebResponse)requets.GetResponse();
                    ...
                    if (htmlCorreo != "")
                       await _CorreoService.EnviarCorreo(usuario_creado.Correo, "Cienta Creada ", htmlCorreo);
                }
        ...
        public  async Task<Usuario> Editar(Usuario entidad, Stream Foto = null, string NombreFoto = "")
        {
            ...
            try
            {
                ...
                if(Foto != null)
                {
                    string urlFoto = await _FireBaeService.SubirStorage(Foto, "carpeta_usuario", usuario_editar.NombreFoto);
                    usuario_editar.UrlFoto = urlFoto;
                }

                bool repuesta = await _repositorio.Editar(usuario_editar); 
        ...
        public async Task<bool> Eliminar(int IdUsuario)
        {
            ...
            try
            {
                ...
                if (!respuesta)
                    await _FireBaeService.EliminarStorage("carpeta_usuario" , nombreFoto);
        ...
        public async Task<Usuario> ObtenerPorCredenciales(string correo, string clave)
        {
            ...
            Usuario usuario_encontrado = await _repositorio.Obtener(u => u.Correo.Equals(correo) && u.Clave
            .Equals(clave_encriptada));
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No enecontramos ningun usuario asociado al correo ");
                ...
                if (!correo_enviado)
                    throw new TaskCanceledException("Tenemos probelmas , intentelo mas tarde");
