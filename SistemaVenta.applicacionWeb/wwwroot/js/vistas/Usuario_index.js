...
$("#btnGuardar").click(function () {
    ...
    const modelo = Object.assign({}, MODELO_BASE);
    modelo["idUsuario"] = parseFloat($("#txtId").val());
...
$("#tbdata tbody").on("click", ".btn-editar", function () {
    ...
    const ddata = tablaData.row(filaSeleccionada).data();
    console.log(ddata)
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        ...
        Text: `Eliminar al Uusario "${ddata.nombre}"`,
        type: "warning",
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Usuario/Eliminar?IdUsuario=${ddata.idUsuario}`, {
                    method: "DELETE",
                })
                    .then(response => {
